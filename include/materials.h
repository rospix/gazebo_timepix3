...
// Elements
const static Material Si   = Material("Si", 2.329, 0.14695218878599284, 0.029315497457424698);
...
const static Material air      = Material("air", 1.275E-3, 0.18309591, 0.0770994336217);
